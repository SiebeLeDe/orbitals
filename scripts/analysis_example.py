...
orbs = calc_analyzer.get_sfo_orbitals(frag1_orb_range=(5, 5), frag2_orb_range=(5, 5))
...
orbs = calc_analyzer.get_mo_orbitals(orb_range=(4, 4))
...
summary = (calc_analyzer(orb_range=(5, 5)))
print(summary)
